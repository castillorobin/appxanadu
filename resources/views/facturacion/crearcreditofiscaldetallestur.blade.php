...
<hr>
        <div class="row">
                  ...
                  <form action="/facturacion/detalleaddfiscaltur" method="get">
                        @csrf
                                @method('GET')
...
<table id="prove" class="table table-bordered shadow-lg mt-4 cell-border">
    ...
    <tbody>{{ $subtotal=0 }}{{ $turismo=0 }}{{ $iva=0 }}
        ...
        <td class="opciones text-center" style="">
            ...
            <a href="/facturacion/borrardetfiscaltur/{{ $detalles[$i]->id }}">
            <button type="button" class="btn btn-danger">Borrar</button>
            </a>
       @if($detalles[$i]->descripcion == 'Habitacion')     
       <input type="text" value="{{ $turismo = $turismo  + (($detalles[$i]->total / 1.18) * 0.05) }}" hidden> 
       @else
<input type="text" value="{{ $iva = $iva  + (($detalles[$i]->total / 1.13) * 0.13) }}" hidden> 
 @endif
        ...
        <tr >
            ...
            <tr >
                ...
                <td style="text-align: center; font-size:13px;">Turismo: </td>
            ...
            <tr >
                ...
                <td style="text-align: center;">$ {{ round($iva,2)}}</td>
...
&nbsp; &nbsp; &nbsp;
<a href="/facturacion/generardtefiscaltur/{{ $cotiactual[0]->id}}">
